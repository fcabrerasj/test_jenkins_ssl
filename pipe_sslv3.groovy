...
def loadCertificateSecret(String certificatePath, String keyPath) {
    script {
        sh "openssl pkcs12 -export -in ${certificatePath} -inkey ${keyPath} -out keystore.p12 -password pass:changeit"
        sh "openssl pkcs12 -in keystore.p12 -out keystore.jks -passin pass:changeit -passout pass:changeit"
